...
export const kashYieldABI = [
  ...
  { inputs: [], name: "processingWindowStart", outputs: [{ name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [], name: "exchangeFacade", outputs: [{ name: "", type: "address" }], stateMutability: "view", type: "function" },
  { inputs: [{ name: "amount", type: "uint256" }], name: "approveExchangeFacadeUsdc", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [], name: "maxSwapSlippageBps", outputs: [{ name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  { inputs: [{ name: "batchCycle", type: "uint256" }, { name: "user", type: "address" }], name: "redeemClaimed", outputs: [{ name: "", type: "bool" }], stateMutability: "view", type: "function" },
  {
    inputs: [{ name: "batchCycle", type: "uint256" }],
    name: "batchClaimInfo",
    outputs: [
  ...
  { inputs: [{ name: "amount", type: "uint256" }, { name: "minOut", type: "uint256" }], name: "swapForUsdc", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [{ name: "usdcAmount", type: "uint256" }, { name: "minOut", type: "uint256" }], name: "swapFromUsdc", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [{ name: "_facade", type: "address" }], name: "setExchangeFacade", outputs: [], stateMutability: "nonpayable", type: "function" },
